...
function checkIsClosed(context, config, repoInfo, credentials, author, pr) {
    return withJiraIssue(context, repoInfo, pr, config, function (data) {
        ...
        if (config.postMergeStatus.find(function (s) { return s == jiraStatus; })) {
            ...
            return context.github.issues
                .createComment(__assign({}, repoInfo, { issue_number: pr.number, body: "@" + author + " " + msg + ". Please check it." }))
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    config = _a.sent();
                    return [2 /*return*/, withJiraIssue(context, repo, pr, config, function (data) { return __awaiter(_this, void 0, void 0, function () {
                            var issue, url;
                            return __generator(this, function (_a) {
...
function checkMilestone(context, repo, config, pr, issue, issueUrl) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (found >= 0) {
                return [2 /*return*/, toggleState(context, repo, StatusContext, pr.head.sha, 'success', "Consistent with JIRA issue " + issue.key, Option_1.some(issueUrl))];
            }
            else {
                ...
                return [2 /*return*/, toggleState(context, repo, StatusContext, pr.head.sha, 'error', description, Option_1.some(issueUrl))];
            }
            return [2 /*return*/];
        });
    });
}
function withJiraIssue(context, repoInfo, pr, config, f) {
    return __awaiter(this, void 0, void 0, function () {
        var issueKey;
        var _this = this;
        return __generator(this, function (_a) {
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, either.fold(function (msg) {
                                    ...
                                    return toggleState(context, repoInfo, StatusContext, pr.head.sha, 'error', msg, Option_1.none);
                                }, function (issue) {
...
function toggleState(bot, repo, statusContext, sha, expectedState, msg, url) {
    return getCommitStatus(bot, repo, sha, statusContext).then(function (st) {
...
function getCommitStatus(bot, repo, ref, ctx) {
    return bot.github.repos.listStatusesForRef(__assign({}, repo, { ref: ref })).then(function (resp) {
...
module.exports = function (app) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, util_1.fromEither(pullrequest_1.PullRequestEvent.decode(context.payload))];
                case 1:
                    event = _a.sent();
                    context.log.debug('Event', event);
    ...
    app.on('issues.demilestoned', function (context) {
        return withIssuePR(context, function (pr) { return __awaiter(_this, void 0, void 0, function () {
            var repo, config;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        config = _a.sent();
                        return [2 /*return*/, withJiraIssue(context, repo, pr, config, function (data) {
                                var issue = data[0], url = data[1];
                                var msg = "Milestone expected to check with JIRA issue " + issue.key;
                                return toggleState(context, repo, StatusContext, pr.head.sha, 'failure', msg, Option_1.some(url));
                            })];
                }
            });
        }); });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, checkIsClosed(context, config, repoInfo, credentials, pr.user.login, pr).then(function (_r) { return check(items.slice(1)); })];
                    }
                });
            });
        }
